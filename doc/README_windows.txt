...
Copyright (c) 2013 Naanayam Developers
...
Intro
-----
Naanayam is a free open source project derived from PPCoin, with
...
After completing windows setup then run windows command line (cmd)
  cd daemon
  Naanayamd
You would need to create a configuration file Naanayam.conf in the default
wallet directory. Grant access to Naanayamd.exe in anti-virus and firewall
...
Naanayamd backupwallet <destination_backup_file>
Then shutdown ppcoind by
Naanayamd stop
Start up the new Naanayamd (0.3.0).

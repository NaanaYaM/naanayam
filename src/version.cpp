...
// for both Naanayamd and Naanayam-qt, to make it harder for attackers to
// target servers or GUI users specifically.
const std::string CLIENT_NAME("Naanayam");

// Client version number
#define CLIENT_VERSION_SUFFIX   "-NYM"
...
#        define BUILD_DATE "Sept. 29, 2013"
#    else

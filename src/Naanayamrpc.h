...
#ifndef _BOUNTYCOINRPC_H_
#define _BOUNTYCOINRPC_H_ 1
...
enum RPCErrorCode
{
    ...
    // P2P client errors
    RPC_CLIENT_NOT_CONNECTED        = -9,  // Naanayam is not connected
...
/**
 * Naanayam RPC command dispatcher.
 */
class CRPCTable
{
private:
